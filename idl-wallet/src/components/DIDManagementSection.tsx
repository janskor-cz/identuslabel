 ...
 * Rendered inside the Key Management page (was previously its own top-level page/nav item).
 */
export const DIDManagementSection: React.FC = () => {
    ...
    const handleCreatePrismDID = async () => {
        ...
        if (!app.defaultSeed) {
            setCreateError('Wallet seed not ready yet. Please wait for wallet to finish initializing.');
            return;
        }
    ...
    return (
        <DBConnect>
            <Box>
                ...
                <p className="text-slate-400 text-sm mb-6">Create and manage your PRISM DIDs</p>
