...
const COMPANIES = {
  techcorp: {
    ...
    apiKey: process.env.TECHCORP_API_KEY || 'b45cde041306c6bceafee5b1da755e49635ad1cd132b26964136a81dda3e0aa2',
  ...
  acme: {
    ...
    enterpriseAgentName: 'ACME Corporation Enterprise Agent',
    walletId: '5d177000-bb54-43c2-965c-76e58864975a',
    entityId: 'e7537e1d-47c2-4a83-a48d-b063e9126858',
    apiKey: process.env.ACME_API_KEY || 'a5b2c19cd9cfe9ff0b9f7bacfdc9d097ae02074b3ef7b03981a8d837c0d0a784',
  ...
  evilcorp: {
    ...
    enterpriseAgentName: 'EvilCorp Industries Enterprise Agent',
    walletId: '3d06f2e3-0c04-4442-8a3d-628f66bf5c72',
    entityId: '2f0aa374-8876-47b0-9935-7978f3135ec1',
    apiKey: process.env.EVILCORP_API_KEY || '83732572365e98bc866e2247a268366b55c44a66348854e98866c4d44e0480a7',
